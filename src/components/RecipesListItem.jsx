...
function RecipesListItem({ recipe }) {
  return (
    <div className="w-full md:w-1/2 xl:w-1/3 px-4">
      <div className="bg-[#f6f9f0] rounded-lg overflow-hidden mb-10 inline-flex flex-col items-center justify-center">
        <img className="w-full " src={recipe.image} alt={recipe.name} />
        <h2 className="p-8 sm:p-9 md:p-7 xl-p-9 text-center">Name: {recipe.name}</h2>
        <Link
          to="#"
